...
class LessorPaginatedSortableTable extends StatefulWidget {
  final List<LessorModel?> data;

  const LessorPaginatedSortableTable({super.key, required this.data});

  @override
  _LessorPaginatedSortableTableState createState() =>
      _LessorPaginatedSortableTableState();
}

class _LessorPaginatedSortableTableState
    extends State<LessorPaginatedSortableTable> {
  int _rowsPerPage = 10;
  int _sortColumnIndex = 0;
  bool _sortAscending = true;
  late List<LessorModel> _sortedData;
  int _currentPage = 0;
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    ...
    List<LessorModel> pageData = _sortedData.sublist(startIndex, endIndex);
