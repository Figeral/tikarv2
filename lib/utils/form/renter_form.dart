...
class RenterForm extends StatefulWidget {
  final double width;
  final double height;
  const RenterForm({super.key, required this.width, required this.height});
...
class _RenterFormState extends State<RenterForm> {
  ...
  final List<String> _jobRoles = ['Personne', "Entreprise"];

  @override
  Widget build(BuildContext context) {
    final _lessorCubit = context.cubit<RenterCubit>();
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                    content: Text(
                                        'Error creating Renter: ${e.toString()}')),
                              );
                            }
                          }
                        },
